...
<body class="bg-dark">
	...
	<div class="container">
		<div class="card card-register mx-auto mt-5 mb-5">
			<div class="card-header"><h4 style="text-align: center;">Hasil Voting Band</h4></div>
			<?php if ($band_aktif != null) { ?>
				<div class="card-body">
					<div id="alert"></div>
					<?php if (($band_aktif->jlh_vote) >= 100) { ?>
					...
					<?php } ?>
					<img src="img/band.jpeg" width="100%" style="margin-bottom: 10px;">
					...
					<?php if ($curr_date > $band_aktif->waktu_aktif) { ?>
							...
							<div class="form-group">
								<div class="form-row">
									...
									<div class="col-md-6" style="margin-bottom: 30px;">
										...
										<h1 style="text-align: center; font-size: 70px;"><?php echo $band_aktif->jlh_vote; ?></h1>
									</div>
								</div>
							</div>
						</form>
