...
<body class="bg-dark">
	...
	<div class="container">
		<div class="card card-register mx-auto mt-5 mb-5">
			<div class="card-header"><h4 style="text-align: center;">Hasil Voting Fashion</h4></div>
			<?php if ($fashion_aktif != null) { ?>
				<div class="card-body">
					<div id="alert"></div>
					<?php if (($fashion_aktif->jlh_vote) >= 100) { ?>
					...
					<?php if ($curr_date > $fashion_aktif->waktu_aktif) { ?>
						<form method="POST" action="lomba/Fashion/addVotingFashion" id="form1" enctype="multipart/form-data">
							<div class="form-group">
								<div class="form-row">
									...
									<div class="col-md-6" style="margin-bottom: 30px;">
										...
										<h1 style="text-align: center; font-size: 70px;"><?php echo $fashion_aktif->jlh_vote; ?></h1>
									</div>
								</div>
							</div>
						</form>
