...
<body class="bg-dark">
		...
		<div class="card card-register mx-auto mt-5 mb-5">
			...
			<div class="card-body">
				...
				<form method="POST" action="lomba/Band/addVotingBand" id="form1" enctype="multipart/form-data">
					<input type="hidden" name="id_balai" id="id_balai" value="<?= htmlspecialchars($id_balai, ENT_QUOTES, 'UTF-8'); ?>">
					<div class="form-group">
                        ...
                        <option value="0" id="plh-kgt">-- Pilih Kegiatan --</option>
							<?php foreach($getkgt as $kgt): ?>
			                	<option value="<?= htmlspecialchars($kgt->id_kegiatan, ENT_QUOTES, 'UTF-8'); ?>"><?= htmlspecialchars($kgt->nama_kegiatan, ENT_QUOTES, 'UTF-8'); ?></option>
			                <?php endforeach; ?>
			            </select>
					</div>
                    ...
                    <div class="form-group" id="form-pnd">	
                        ...
                        <input type="radio" id="sd" name="pend" value="SD">
                        <label >SD</label><br>
						<input type="radio" id="smp" name="pend" value="SMP">
                        <label >SMP</label><br>
                        <input type="radio" id="sma" name="pend" value="SMA">
                        <label >SMA</label><br>
                        <input type="radio" id="s1" name="pend" value="S1">
                        <label >S1</label><br>
						<input type="radio" id="s2" name="pend" value="S2">
                        <label >S2</label><br>
						<input type="radio" id="s3" name="pend" value="S3">
                        <label >S3</label><br>
					</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			let judulUnker = <?= htmlspecialchars($_GET['balai'] ?? '', ENT_QUOTES, 'UTF-8'); ?>;
            let judulLayanan = '<?= htmlspecialchars($_GET['layanan'] ?? '', ENT_QUOTES, 'UTF-8'); ?>'; // Escape output here
